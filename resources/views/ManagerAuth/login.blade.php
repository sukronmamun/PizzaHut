     ...
     <div class="row">
            <div class="login-main">
                ...
                <div class="form">
                  ...
                  <form class="col s12" role="form" method="POST" action="{{ url('/manager/login') }}">
                      {{ csrf_field() }}
                   <div class="input-field col s10 offset-s1">
                     <input id="email" type="email" class="validate"  name="email" value="{{ old('username') }}" required autofocus>
